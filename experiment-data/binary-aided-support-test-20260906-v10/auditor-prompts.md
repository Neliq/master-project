...
Process every task in `/home/neliq/Coding/master-project/experiment-data/binary-aided-support-test-20260906-v10/assignments/agent-XX.json` exactly once and in order. Write exactly one JSON object per task to `/home/neliq/Coding/master-project/experiment-data/binary-aided-support-test-20260906-v10/results/raw-not-aided/agent-XX.jsonl`.
...
The only aid is `/home/neliq/Coding/master-project/experiment-data/binary-aided-support-test-20260906-v10/arms/aided/formalizations-pseudocode.md`. It contains general pseudocode rules with context gates and no demonstrations or labelled cases. First record `base_label` from live evidence alone. Then nominate at most three plausible rule IDs from the page and apply formalizations only to those candidates; do not globally apply or OR all ten rules.
