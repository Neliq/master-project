...
Original formula (verbatim): `U_{\mathrm{default}} = U_{\mathrm{system}} - D_{\mathrm{artificial}} \quad \land \quad \frac{U_{\mathrm{default}}}{U_{\mathrm{system}}} < \tau_{\mathrm{default\_utility}}`
...
Original formula (verbatim): `\lambda_{\mathrm{friction}}(t_2) > \lambda_{\mathrm{friction}}(t_1) \quad \land \quad \mathrm{PromptAppears}(N_{\mathrm{prompt}},t_2) = \mathrm{True} \quad (t_2 > t_1)`
