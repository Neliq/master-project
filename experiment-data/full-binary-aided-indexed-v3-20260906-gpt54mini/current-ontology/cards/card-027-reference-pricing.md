...
## Condition 1: 1. Discount Magnitude and Reference-Claim Support

Original formula (verbatim): `P_{\mathrm{ref}} > 0 \quad \land \quad \Delta_{\mathrm{pct}} = \frac{P_{\mathrm{ref}} - P_{\mathrm{cur}}}{P_{\mathrm{ref}}} \quad \land \quad \Delta_{\mathrm{pct}} > \tau_{\mathrm{unrealistic}} \quad \land \quad \mathrm{RefClaimSupported}(N_{\mathrm{ref}}) = \mathrm{False}`
