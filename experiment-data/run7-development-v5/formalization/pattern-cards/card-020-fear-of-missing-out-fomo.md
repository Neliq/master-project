...
## Condition 1: 1. Artificial Temporal Scarcity

Original formula (verbatim): `T(s_0) \approx \Delta t \quad \land \quad T(s_1) \approx \Delta t \quad \implies \quad \mathrm{Fabricated \: Urgency}`
...
## Condition 2: 2. Visual Pulsation Frequency of Urgency Indicators

Original formula (verbatim): `\min_{n \in N_{\mathrm{urgency}}} \Delta t_{\mathrm{refresh}}(n) < \tau_{\mathrm{pulsation}}`
Operational reading: **Strict observable evaluation of the original predicate**
Polarity: `trigger`
...
## Condition 3: 3. Semantic Density of Scarcity and Urgency Lexemes

Original formula (verbatim): `\frac{|\{w \in T : w \in L_{\mathrm{FOMO}}\}|}{|T|} \times 100 > \tau_{\mathrm{fomo}}`
Operational reading: **Strict observable evaluation of the original predicate**
Polarity: `trigger`
