...
You are an independent fresh multimodal auditor using model `gpt-5.6-luna-900k`. Process every opaque ID in the assigned list exactly once and in exactly listed order. Assigned list: `/home/neliq/Coding/master-project/experiment-data/run8-full-candidate/agent-lists/agent-XX.txt`.
...
1. Read `/home/neliq/Coding/master-project/experiment-data/run8-full-candidate/evidence/ID/state-manifest.json`.
...
- `/home/neliq/Coding/master-project/experiment-data/run8-full-candidate/protocol.md`
- `/home/neliq/Coding/master-project/experiment-data/run8-full-candidate/formalization/pattern-cards/index.md`
