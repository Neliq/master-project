...
## Condition 1: 1. Structural Orphaned Nodes

Original formula (verbatim): `d(N_{\mathrm{metric}}, N_{\mathrm{descriptor}}) > \tau_{\mathrm{orphan}}`
...
## Condition 2: 2. Visual Prominence Imbalance Between Metric and Baseline

Original formula (verbatim): `\frac{W(N_{\mathrm{metric}})}{W(N_{\mathrm{context}})} > \tau_{\mathrm{context\_imbalance}} \quad \land \quad \mathrm{CR}(N_{\mathrm{metric}}, L_{\mathrm{bg}}) > 7.0`
Operational reading: **Strict observable evaluation of the original predicate**
Polarity: `trigger`
...
## Condition 3: 3. Unanchored Quantitative Metrics

Original formula (verbatim): `v \in N_{\mathrm{info}} \quad \land \quad (U_{\mathrm{val}} \notin S_{\mathrm{cluster}} \lor B_{\mathrm{val}} \notin S_{\mathrm{cluster}})`
Operational reading: **Strict observable evaluation of the original predicate**
Polarity: `trigger`
