...
## Condition 3: 3. Jointly Satisfiable Claims (Counterevidence)

Original formula (verbatim): `\mathrm{Satisfiable}\!\left(\mathrm{Sem}(t_1) \land \mathrm{Sem}(t_2)\right) = \mathrm{True} \quad \text{(counterevidence only)}`
