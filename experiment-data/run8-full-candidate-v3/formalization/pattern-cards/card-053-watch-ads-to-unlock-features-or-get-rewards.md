...
## Condition 1: 1. Attention as Transactional Currency

Original formula (verbatim): `\int_{0}^{\Delta t_{\mathrm{ad}}} E_{\mathrm{playback}}(t) \, dt = \Delta t_{\mathrm{ad}} \implies \mathrm{State}(R_{\mathrm{target}}) \to \mathrm{Unlocked}`
...
## Condition 2: 2. Visual Mismatch Between Reward Progress Display and Actual Progress

Original formula (verbatim): `P_{\mathrm{visual}} - P_{\mathrm{actual}} > \tau_{\mathrm{mislead}}`
Operational reading: **Strict observable evaluation of the original predicate**
Polarity: `trigger`
...
## Condition 3: 3. Semantic Inflation of Reward Value

Original formula (verbatim): `\mathrm{Hyperbole}(T_{\mathrm{reward}}) - \mathrm{Utility}(R_{\mathrm{actual}}) > \tau_{\mathrm{hype\_gap}}`
Operational reading: **Strict observable evaluation of the original predicate**
Polarity: `trigger`
