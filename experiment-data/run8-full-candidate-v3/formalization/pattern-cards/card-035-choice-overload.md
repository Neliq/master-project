...
## Condition 1: 1. Excessive Element Quantization

Original formula (verbatim): `|C_{\mathrm{choices}}| > \tau_{\mathrm{overload}}`
...
## Condition 2: 2. Visual Density of Interactive Decision Elements

Original formula (verbatim): `\rho = \frac{n_{\mathrm{interactive}}}{A_{\mathrm{viewport}}} > \tau_{\mathrm{density}}`
Operational reading: **Strict observable evaluation of the original predicate**
Polarity: `trigger`
...
## Condition 3: 3. Semantic Similarity Collapse Among Options

Original formula (verbatim): `\frac{1}{|C|(|C|-1)} \sum_{i \neq j} \mathrm{sim}(T_i, T_j) > \tau_{\mathrm{similarity}}`
Operational reading: **Strict observable evaluation of the original predicate**
Polarity: `trigger`
