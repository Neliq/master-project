...
You are an independent fresh multimodal auditor using model `gpt-5.6-luna-900k`. Process every opaque ID in the assigned list exactly once and in exactly listed order. Assigned list: `/home/neliq/Coding/master-project/experiment-data/run8-full-candidate-v3/agent-lists/agent-XX.txt`.
...
1. Read `/home/neliq/Coding/master-project/experiment-data/run8-full-candidate-v3/evidence/ID/state-manifest.json`.
...
- `/home/neliq/Coding/master-project/experiment-data/run8-full-candidate-v3/protocol.md`
- `/home/neliq/Coding/master-project/experiment-data/run8-full-candidate-v3/formalization/pattern-cards/index.md`
