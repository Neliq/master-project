...
Process every task in `/home/neliq/Coding/master-project/experiment-data/full-binary-aided-pattern-extension-v8-20260910-gpt56luna900k/assignments/not-aided/agent-XX.json` exactly once and in order. Write exactly one JSON object per task to `/home/neliq/Coding/master-project/experiment-data/full-binary-aided-pattern-extension-v8-20260910-gpt56luna900k/results/raw-not-aided/agent-XX.jsonl`. Use only live rendered evidence; do not read source, ontology, score-only, other assignments, or prior results.
