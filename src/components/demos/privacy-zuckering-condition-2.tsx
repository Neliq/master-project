...
export function PrivacyZuckeringCond2({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      ...
      caption="Semantic Ambiguity of Third-Party Entities — critical info hidden through extreme typographic camouflage." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border bg-foreground/5 p-3 text-xs">
          <div className="mb-1 font-medium">Semantic Ambiguity of Third-Party Entities</div>
          <p className="text-[11px]">Subscribe now. Cancel anytime.</p>
          <p className="mt-2 leading-relaxed" style={{fontSize: "3px", opacity: 0.06}}>
