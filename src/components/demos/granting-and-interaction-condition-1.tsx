...
export function GrantingAndInteractionCond1({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      ...
      caption="Interaction Gating — social or parasocial pressure manipulates behavior." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md bg-purple-500/5 border border-purple-500/30 p-3 text-xs">
          <div className="font-medium text-purple-700 dark:text-purple-300">Interaction Gating</div>
