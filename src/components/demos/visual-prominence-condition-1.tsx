...
export function VisualProminenceCond1({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      ...
      caption="Absolute Bounding Box Dominance — social or parasocial pressure manipulates behavior." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md bg-indigo-500/5 border border-indigo-500/30 p-3 text-xs">
          <div className="font-medium text-indigo-700 dark:text-indigo-300">Absolute Bounding Box Dominance</div>
