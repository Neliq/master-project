...
export function ConfirmshamingCond1({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      ...
      caption="Semantic Asymmetry — one action is trivially easy, the other is disproportionately hard." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border p-3 text-xs">
          <div className="mb-2 font-medium">Semantic Asymmetry</div>
          <div className="flex items-center gap-2 mb-2">
            <div className="bg-pink-500 hover:bg-pink-600 text-white rounded-full px-3 py-1.5 text-[10px] font-medium">Accept</div>
