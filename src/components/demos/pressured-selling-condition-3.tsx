...
export function PressuredSellingCond3({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      ...
      caption="Localized Temporal or Visual Constraints — provider-favorable option dominates visually." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border bg-foreground/5 p-3 text-xs">
          <div className="mb-2 font-medium">Localized Temporal or Visual Constraints</div>
          <div className="space-y-2">
            <div className="border-blue-500/40 border-2 bg-blue-500/5 rounded-lg p-6 text-center">
