...
export function AutomaticAcceptThirdPartyTermCond3({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      title="Automatic Accept Third Party Term: Asymmetric Review Friction"
      caption="Asymmetric Review Friction — one action is trivially easy, the other is disproportionately hard." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border p-3 text-xs">
          <div className="mb-2 font-medium">Asymmetric Review Friction</div>
          <div className="flex items-center gap-2 mb-2">
            <div className="bg-amber-500 hover:bg-amber-600 text-white rounded-full px-3 py-1.5 text-[10px] font-medium">Accept</div>
