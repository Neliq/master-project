...
export function AutomatingTheUserAwayCond3({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      title="Automating The User Away: Asymmetric Control Reversion"
      caption="Asymmetric Control Reversion — one action is trivially easy, the other is disproportionately hard." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border p-3 text-xs">
          <div className="mb-2 font-medium">Asymmetric Control Reversion</div>
