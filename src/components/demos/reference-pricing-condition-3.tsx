...
export function ReferencePricingCond3({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      title="Reference Pricing: Obfuscation of Legal Historical Baselines"
      caption="Obfuscation of Legal Historical Baselines — critical info hidden through extreme typographic camouflage." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border bg-foreground/5 p-3 text-xs">
          <div className="mb-1 font-medium">Obfuscation of Legal Historical Baselines</div>
