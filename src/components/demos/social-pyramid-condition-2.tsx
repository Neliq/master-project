          ...
          {benignCopied && (
            <div className="rounded-md border border-border/60 bg-muted/40 p-2.5 text-[9px] leading-relaxed">
              ...
              <p className="text-muted-foreground">
                ...
                <strong className="text-foreground">{AREA_BENIGN}</strong> &le;{" "}
        ...
        <div className="rounded-md border border-border/60    p-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-1">
              <span className="rounded-full border border-border/60 bg-muted/40 px-1.5 py-0.5 text-[8px] font-mono font-semibold text-foreground">
                Bronze
              </span>
          ...
          <div className="mt-2 text-center">
            ...
            <div className="mt-1 text-[8px] font-semibold uppercase tracking-wider text-foreground">
