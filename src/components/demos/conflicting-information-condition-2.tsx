...
export function ConflictingInformationCond2({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      ...
      caption="Semantic-Visual Mismatch — provider-favorable option dominates visually." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border bg-foreground/5 p-3 text-xs">
          <div className="mb-2 font-medium">Semantic-Visual Mismatch</div>
          <div className="rounded-xl border-teal-500/40 border-2 bg-teal-500/5 p-4 text-center shadow-lg">
            <div className="text-xs font-bold">Conflicting Information Premium</div>
