...
export function ConflictingInformationCond3({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      title="Conflicting Information: Action versus Label Discrepancy"
      caption="Action versus Label Discrepancy — there is no way to dismiss this element." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border bg-foreground/5 p-3 text-xs">
          <div className="mb-1 font-medium">Action versus Label Discrepancy</div>
