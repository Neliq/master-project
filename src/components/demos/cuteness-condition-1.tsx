      ...
      benign={
        <div className="space-y-3">
          <div className="rounded-md border bg-card p-3">
            ...
            {darkStage === "onboard" && (
              <div className="mt-3 rounded-md border border-border/60 bg-muted/40 p-2.5 text-[9px]">
        ...
        <div className="rounded-md border bg-card p-3">
          ...
          {darkStage === "cancel" && (
            <div className="mt-3 space-y-2">
              ...
              <div className="flex flex-col items-center gap-2 rounded-md border border-border/60 bg-muted/40 p-3 text-center">
