...
export function PersuasiveLanguageCond2({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      title="Persuasive Language: Connotative Sentiment Asymmetry"
      caption="Connotative Sentiment Asymmetry — one action is trivially easy, the other is disproportionately hard." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border p-3 text-xs">
          <div className="mb-2 font-medium">Connotative Sentiment Asymmetry</div>
          <div className="flex items-center gap-2 mb-2">
            <div className="bg-blue-500 hover:bg-blue-600 text-white rounded-full px-3 py-1.5 text-[10px] font-medium">Accept</div>
