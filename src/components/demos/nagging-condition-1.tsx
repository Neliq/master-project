      ...
      benign={
        <div className="space-y-3">
          <div className="rounded-md border bg-card p-4">
            ...
            <button className="mt-3 rounded-md bg-primary px-3 py-1.5 text-[10px] font-medium text-primary-foreground">Open profile</button>
          </div>
      ...
      <div className="space-y-3">
        <div className="rounded-md border border-border/60 bg-card p-4">
          ...
          <div className="mt-3 flex gap-2">
            <button className="rounded-md bg-primary px-3 py-1.5 text-[10px] font-medium text-primary-foreground">Add photo</button>
        ...
        {darkPrompt && <div className="rounded-md border border-border/60 bg-muted/40 p-3 text-[10px] text-muted-foreground">The same setup request returned after dismissal ({dismissals} dismissal{dismissals === 1 ? "" : "s"}).</div>}
      </div>
    </DemoShell>
  );
}
