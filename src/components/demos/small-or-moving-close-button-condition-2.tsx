...
export function SmallOrMovingCloseButtonCond2({
  ...
  return (
    <DemoShell mode={mode}
          ...
          <div className="relative rounded-md border bg-card p-3">
            {!bDismissed ? (
              <button
                ...
                className="absolute right-2 top-2 flex h-11 w-11 items-center justify-center rounded-md border border-border/60 bg-muted/40 text-foreground transition-colors hover:bg-muted/60 cursor-pointer"
              >
      ...
      <div className="space-y-3">
        <div className="relative rounded-md border-2 border-border/60 bg-card p-3">
          {!aDismissed && (
            <button
