...
export function PlainEvilCond2({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      title="Plain Evil (Theoretical Construct): Absolute Agency Deprivation"
      caption="Absolute Agency Deprivation — critical info hidden through extreme typographic camouflage." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border bg-foreground/5 p-3 text-xs">
          <div className="mb-1 font-medium">Absolute Agency Deprivation</div>
