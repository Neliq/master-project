...
export function PayToPlayCond3({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      title="Pay-To-Play: Competitive Statistical Asymmetry"
      caption="Competitive Statistical Asymmetry — one action is trivially easy, the other is disproportionately hard." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border p-3 text-xs">
          <div className="mb-2 font-medium">Competitive Statistical Asymmetry</div>
