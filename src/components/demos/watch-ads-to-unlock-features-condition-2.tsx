...
export function WatchAdsToUnlockFeaturesCond2({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      title="Watch Ads To Unlock Features Or Get Rewards: Artificial Resource Starvation"
      caption="Artificial Resource Starvation — provider-favorable option dominates visually." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border bg-foreground/5 p-3 text-xs">
          <div className="mb-2 font-medium">Artificial Resource Starvation</div>
          <div className="rounded-xl border-purple-500/40 border-2 bg-purple-500/5 p-4 text-center shadow-lg">
            <div className="text-xs font-bold">Watch Ads To Unlock Features Or Get Rewards Premium</div>
