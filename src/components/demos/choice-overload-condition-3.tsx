...
export function ChoiceOverloadCond3({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      title="Choice Overload: Linear Scaling of Interaction Cost"
      caption="Linear Scaling of Interaction Cost — critical info hidden through extreme typographic camouflage." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border bg-foreground/5 p-3 text-xs">
          <div className="mb-1 font-medium">Linear Scaling of Interaction Cost</div>
