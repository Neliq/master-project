...
export function BadDefaultsPreselectionCond3({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      ...
      caption="Visual or Structural Obfuscation — provider-favorable option dominates visually." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border bg-foreground/5 p-3 text-xs">
          <div className="mb-2 font-medium">Visual or Structural Obfuscation</div>
          <div className="flex gap-2">
            <div className="bg-pink-500 hover:bg-pink-600 text-white rounded-full px-4 py-2 text-[10px] font-bold">Premium $19.99/mo</div>
