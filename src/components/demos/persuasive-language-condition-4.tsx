...
export function PersuasiveLanguageCond4({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      title="Persuasive Language: Intentional Syntactic Obfuscation"
      caption="Intentional Syntactic Obfuscation — critical info hidden through extreme typographic camouflage." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border bg-foreground/5 p-3 text-xs">
          <div className="mb-1 font-medium">Intentional Syntactic Obfuscation</div>
          <p className="text-[11px]">Subscribe now. Cancel anytime.</p>
          <p className="mt-2 leading-relaxed" style={{fontSize: "4px", opacity: 0.08}}>
