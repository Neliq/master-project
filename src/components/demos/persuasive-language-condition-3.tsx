...
export function PersuasiveLanguageCond3({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      title="Persuasive Language: Density of Manipulative Lexicon"
      caption="Density of Manipulative Lexicon — manufactured countdown creates pressure to act before thinking." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border-indigo-500/40 bg-indigo-500/5 p-3 text-xs">
          <div className="mb-1 font-medium text-indigo-700 dark:text-indigo-300">Density of Manipulative Lexicon</div>
