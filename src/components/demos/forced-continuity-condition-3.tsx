...
export function ForcedContinuityCond3({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      title="Forced Continuity: Asymmetric Offboarding Friction"
      caption="Asymmetric Offboarding Friction — one action is trivially easy, the other is disproportionately hard." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border p-3 text-xs">
          <div className="mb-2 font-medium">Asymmetric Offboarding Friction</div>
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <div className="bg-amber-500 hover:bg-amber-600 text-white rounded-md px-3 py-1.5 text-[10px]">1-click Accept</div>
