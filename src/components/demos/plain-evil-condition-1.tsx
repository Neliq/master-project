...
export function PlainEvilCond1({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      ...
      caption="Dark Pattern Singularity — provider-favorable option dominates visually." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border bg-foreground/5 p-3 text-xs">
          <div className="mb-2 font-medium">Dark Pattern Singularity</div>
          <div className="rounded-xl border-amber-500/40 border-2 bg-amber-500/5 p-4 text-center shadow-lg">
            <div className="text-xs font-bold">Plain Evil (Theoretical Construct) Premium</div>
