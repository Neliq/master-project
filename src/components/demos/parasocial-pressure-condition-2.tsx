...
export function ParasocialPressureCond2({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      ...
      caption="Manufactured Livelihood Dependency — messages appear to come from the user without consent." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border bg-foreground/5 p-3 text-xs">
          <div className="mb-1 font-medium">Manufactured Livelihood Dependency</div>
        ...
        {sent && (
          <div className="rounded-md border border-red-500/30 bg-red-500/5 p-3 text-[10px]">
            <div className="font-medium text-red-700 dark:text-red-300">47 invites sent as you!</div>
