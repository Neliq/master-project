...
export function CutenessCond3({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      ...
      caption="Semantic Pairing of Guilt — social or parasocial pressure manipulates behavior." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md bg-amber-500/5 border border-amber-500/30 p-3 text-xs">
          <div className="font-medium text-amber-700 dark:text-amber-300">Semantic Pairing of Guilt</div>
