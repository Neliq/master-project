...
export function CustomisationCond2({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      title="Customisation (Interface Nesting): Interaction Tax and Friction Multiplication"
      caption="Interaction Tax and Friction Multiplication — navigating to the target requires excessive depth." auditorStats={stats}>
