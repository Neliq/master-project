...
export function BundlingCond3({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      ...
      caption="Suppression of Individual Pricing — provider-favorable option dominates visually." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border bg-foreground/5 p-3 text-xs">
          <div className="mb-2 font-medium">Suppression of Individual Pricing</div>
          <div className="rounded-xl border-indigo-500/40 border-2 bg-indigo-500/5 p-4 text-center shadow-lg">
            <div className="text-xs font-bold">Bundling Premium</div>
