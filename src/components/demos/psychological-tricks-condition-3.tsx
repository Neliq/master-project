...
export function PsychologicalTricksCond3({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      ...
      caption="Cognitive Overload — social or parasocial pressure manipulates behavior." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md bg-blue-500/5 border border-blue-500/30 p-3 text-xs">
          <div className="font-medium text-blue-700 dark:text-blue-300">Cognitive Overload</div>
