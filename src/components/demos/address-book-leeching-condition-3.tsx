...
export function AddressBookLeechingCond3({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      title="Address Book Leeching: Shadow Graph Construction"
      caption="Shadow Graph Construction — navigating to the target requires excessive depth." auditorStats={stats}>
