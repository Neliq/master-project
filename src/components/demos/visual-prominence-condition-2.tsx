...
export function VisualProminenceCond2({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      title="Visual Prominence: Relative Luminance and Contrast Differential"
      caption="Relative Luminance and Contrast Differential — provider-favorable option dominates visually." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border bg-foreground/5 p-3 text-xs">
          <div className="mb-2 font-medium">Relative Luminance and Contrast Differential</div>
