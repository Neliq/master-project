...
export function PreDeliveredContentCond2({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      title="Pre-Delivered Content: Artificial Local Access Gating"
      caption="Artificial Local Access Gating — navigating to the target requires excessive depth." auditorStats={stats}>
