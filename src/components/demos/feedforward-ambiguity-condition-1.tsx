...
export function FeedforwardAmbiguityCond1({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      ...
      caption="Semantic Divergence of Action and Outcome — one action is trivially easy, the other is disproportionately hard." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border p-3 text-xs">
          <div className="mb-2 font-medium">Semantic Divergence of Action and Outcome</div>
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <div className="bg-red-500 hover:bg-red-600 text-white rounded-md px-3 py-1.5 text-[10px]">1-click Accept</div>
