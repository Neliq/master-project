...
export function FeedforwardAmbiguityCond3({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      title="Feedforward Ambiguity: State Transition Magnitude vs. Cue Prominence"
      caption="State Transition Magnitude vs. Cue Prominence — provider-favorable option dominates visually." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border bg-foreground/5 p-3 text-xs">
          <div className="mb-2 font-medium">State Transition Magnitude vs. Cue Prominence</div>
          <div className="grid grid-cols-2 gap-2">
            <div className="border-green-500/40 border-2 bg-green-500/5 rounded-md p-3 text-center">
