        ...
        <div className="space-y-3">
          <div className="rounded-md border bg-card p-3">
            ...
            <button
              ...
              className="mt-3 w-full rounded-md bg-primary hover:bg-primary/80 text-primary-foreground py-1.5 px-3 text-[10px] font-medium transition-colors cursor-pointer"
            >
              Accept tracking
            </button>
            ...
            <button
              ...
              className="mt-1.5 w-full rounded-md border border-border/60 bg-background text-foreground hover:bg-muted/40 py-1.5 px-3 text-[10px] font-medium transition-colors cursor-pointer"
            >
              Decline tracking
            </button>
          </div>
