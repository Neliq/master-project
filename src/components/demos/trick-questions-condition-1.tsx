...
export function TrickQuestionsCond1({
  ...
  return (
    <DemoShell mode={mode} annotations={annotations} onRestart={onRestart ?? reset}
      ...
      caption="Syntactic Obfuscation via Multiple Negations — critical info hidden through extreme typographic camouflage." auditorStats={stats}>
      <div className="space-y-3">
        <div className="rounded-md border bg-foreground/5 p-3 text-xs">
          <div className="mb-1 font-medium">Syntactic Obfuscation via Multiple Negations</div>
          <p className="text-[11px]">Subscribe now. Cancel anytime.</p>
          <p className="mt-2 leading-relaxed" style={{fontSize: "4px", opacity: 0.1}}>
