    ...
    <DemoShell mode={mode}
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-[9px] text-muted-foreground mt-0.5">
                  ...
                  <span className="font-semibold text-foreground">{PLAN_PRICE}/month</span>,
      ...
      <div className="space-y-3">
        <div className="rounded-md border bg-card p-3">
          ...
          <div className="mt-3 rounded-md border border-border/60 bg-muted/40 px-3 py-2 text-[9px] text-muted-foreground">
