  ...
  return (
    <header className="site-header sticky top-0 z-50 border-b backdrop-blur">
      <div className="relative mx-auto flex h-20 max-w-7xl items-center justify-center px-4">
        ...
        <Link
          href="/customization"
          className="absolute right-4 shrink-0 border border-white/35 px-2.5 py-2 text-[10px] font-semibold tracking-[0.08em] text-white uppercase transition-colors hover:border-white hover:bg-white/10 sm:px-3 sm:text-xs"
        >
          Customization
        </Link>
      </div>
